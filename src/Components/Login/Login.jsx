...
export default function Login() {
  let {userLogin,setuserLogin,userEmail,setuserEmail}=useContext(UserContext)
...
{ApiError &&  <div className=' w-1/3 mx-auto bg-red-600 text-white font-bold rounded-lg p-3 text-center'>
  {ApiError}
  </div>}
    <h1 className='text-emerald-600 p-5 font-bold text-3xl text-center'>Login Now </h1>
    ...
    <form onSubmit={formik.handleSubmit} className="max-w-md mx-auto">
      ...
      <Link to={"/register"}>
        <span className='text-blue-500 underline'>Don't you have an account? Register Now</span>
      </Link>
